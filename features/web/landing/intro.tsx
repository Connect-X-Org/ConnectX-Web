        ...
        <div className="flex flex-col items-center gap-6 md:gap-12 lg:flex-row">
          <div className="flex flex-1 flex-col gap-4">
            <h2 className="font-medium text-2xl md:text-3xl lg:text-4xl">
              ...
              Its capital city is Kigali. The official languages are
              Kinyarwanda, English, and French, with Swahili also widely spoken.
              The current president is Paul Kagame, leading the country with a
              vision of unity and progress.
            </h2>
            <TheLink
              className="flex items-center gap-1 font-semibold text-blue-600 transition-all duration-300 ease-in hover:tracking-wide dark:text-blue-500"
              href={"/"}
            >
              Learn more
