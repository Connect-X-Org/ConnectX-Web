...
export default function SiteHeader() {
  return (
    ...
    <header className="relative top-0 z-50 flex h-auto w-full flex-col items-center justify-between border-muted/50 border-b shadow-xs lg:relative dark:bg-black">
