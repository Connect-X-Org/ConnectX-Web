...
export const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Tickets", href: "/tickets", external: false },
...
export const houses: THouse[] = [
  {
    ...
    title: "Modern City Apartment in Kigali Heights",
    slug: "modern-city-apartment-in-kigali-heights",
    href: "/",
    description:
      "A sleek apartment in the heart of Kigali offering panoramic city views, modern design, and cozy interiors perfect for short or long stays.",
  },
  {
    src: "/houses/image-2.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Musanze", "Rwanda"],
    title: "Mountain View Eco Lodge",
    slug: "mountain-view-eco-lodge",
    href: "/",
    description:
      "Nestled near the Volcanoes National Park, this eco lodge blends natural charm with comfort. Ideal for nature lovers and adventurers.",
  },
  {
    src: "/houses/image-3.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Gisenyi", "Rubavu"],
    title: "Lakefront Villa Retreat",
    slug: "lakefront-villa-retreat",
    href: "/",
    description:
      "Enjoy serene mornings by Lake Kivu in this spacious villa offering private beach access, a lush garden, and stunning sunset views.",
  },
  {
    src: "/houses/image-4.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Kicukiro", "Kigali"],
    title: "Urban Family Residence",
    slug: "urban-family-residence",
    href: "/",
    description:
      "A comfortable family home with multiple bedrooms, secure parking, and close proximity to schools and shopping centers.",
  },
  {
    ...
    slug: "classic-colonial-house",
    href: "/",
    description:
      "Experience timeless charm in this restored colonial-style home surrounded by greenery and offering a peaceful ambiance.",
  },
  {
    ...
    slug: "luxury-hilltop-mansion",
    href: "/",
    description:
      "A luxurious residence perched on Kigali’s hills, featuring an infinity pool, private gym, and panoramic skyline views.",
  },
  {
    src: "/houses/image-7.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Nyagatare", "Rwanda"],
    title: "Countryside Homestead",
    slug: "countryside-homestead",
    href: "/",
    description:
      "A peaceful retreat surrounded by nature, perfect for guests seeking fresh air, farmland views, and traditional Rwandan warmth.",
  },
  {
    src: "/houses/image-8.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Ruhengeri", "Musanze"],
    title: "Cozy Mountain Cabin",
    slug: "cozy-mountain-cabin",
    href: "/",
    description:
      "A charming wooden cabin offering warmth and simplicity, located near hiking trails and volcano expeditions.",
  },
  {
    src: "/houses/image-9.avif",
    otherImages: ["/houses/a.avif", "/houses/b.avif"],
    place: ["Kibuye", "Karongi"],
    title: "Lakeside Bamboo Cottage",
    slug: "lakeside-bamboo-cottage",
    href: "/",
    description:
      "Built entirely from sustainable bamboo, this cottage provides an eco-friendly stay with lake views and a natural vibe.",
  },
  {
    ...
    href: "/",
    description:
      "A modern studio designed for simplicity and comfort, featuring high-speed internet, a private balcony, and easy city access.",
  },
];
...
export const ticketCategories = [
  { label: "For you", icon: TicketIcon },
  { label: "Concerts", icon: MusicIcon },
  { label: "Live Performances", icon: Mic2Icon },
  { label: "Boxing Matches", icon: Trophy },
  { label: "Basketball Games", icon: DumbbellIcon },
  { label: "Football Matches", icon: Trophy },
  { label: "Cultural Events", icon: Globe2Icon },
  { label: "Conferences & Seminars", icon: Users },
  { label: "Workshops & Training", icon: BookOpenIcon },
  { label: "Film & Theater", icon: Theater },
  { label: "Festivals", icon: PartyPopperIcon },
  { label: "Art Exhibitions", icon: PaletteIcon },
  { label: "Photography Shows", icon: CameraIcon },
  { label: "Heritage & History", icon: Landmark },
  { label: "Corporate Events", icon: Building2 },
  { label: "Special Experiences", icon: SparklesIcon },
];
